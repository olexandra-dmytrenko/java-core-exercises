...
public class AccountAnalytics {
    ...
    public Map<String, List<Account>> groupAccountsByEmailDomain() {
        return accounts.stream().collect(groupingBy(this::getEmailDomain));
    }

    private String getEmailDomain(Account a) {
        return StringUtils.substringAfter(a.getEmail(), "@");
    }
    ...
    public boolean containsAccountWithEmailDomain(String emailDomain) {
        return accounts.stream().anyMatch(a -> getEmailDomain(a).equals(emailDomain));
    }
    ...
    public Map<String, BigDecimal> collectBalancesByIdForAccountsCreatedOn(int year) {
        return accounts.stream().filter(a -> a.getCreationDate().getYear() == year)
    ...
    public Map<Character, Long> getCharacterFrequencyInFirstNames() {
        return accounts.stream().flatMapToInt(a -> a.getFirstName().chars()).mapToObj(c -> (char) c).collect(groupingBy(identity(), counting()));
    }
